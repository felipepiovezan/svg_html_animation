...
class SvgPath:
    ...
    def __declare(self):
        ...
        self.printer.print(
            f'let {self.name_js} = {{path: {query_js}, length: {query_js}.getTotalLength()}}')
...
class SvgGroup:
    ...
    def clear_strokes(self):
        for idx, path in enumerate(self.paths):
            ...
            self.printer.print(
                f'{curr_obj_js}.path.style.strokeDasharray = {curr_length_js} + " " + {curr_length_js}')
            self.printer.print(
                f'{curr_obj_js}.path.style.strokeDashoffset = {curr_length_js}')
...
class SvgAnimator:
    ...
    def start_animation(self):
        self.printer.print(
            f'window.requestAnimationFrame({self.draw_func_js})')
